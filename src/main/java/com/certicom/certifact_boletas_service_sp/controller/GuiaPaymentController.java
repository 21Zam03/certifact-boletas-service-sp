...
public class GuiaPaymentController {
    ...
    private final GuiaPaymentVoucherService guiaPaymentService;
    ...
    public ResponseEntity<Integer> deleteGuiaPaymentById(@PathVariable("id") Long guiaPaymentId) {
        return new ResponseEntity<>(guiaPaymentService.deleteGuiaPaymentVoucherById(guiaPaymentId), HttpStatus.OK);
    }
