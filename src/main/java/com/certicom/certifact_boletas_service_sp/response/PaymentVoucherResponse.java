...
public class PaymentVoucherResponse {
    ...
    private List<GuiaPaymentVoucherResponse> guiasRelacionadas;
    private List<DocumentoRelacionadoResponse> documentosRelacionados;
    private List<LeyendaResponse> leyendas;
    ...
    private List<DetailsPaymentVoucherResponse> items;
    private String denominacionEmisor;
    private String nombreComercialEmisor;
    private String tipoDocumentoEmisor;
    private String identificadorDocumento;
    private String ordenCompra;
    private List<AnticipoPaymentVoucherResponse> anticipos;
    private List<AditionalFieldPaymentVoucherResponse> camposAdicionales;
    private List<PaymentCuotasResponse> cuotas;
    ...
    private List<PaymentVoucherFileResponse> paymentVoucherFileModelList;
